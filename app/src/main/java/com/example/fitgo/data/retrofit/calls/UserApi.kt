...
interface UserApi {
    ...
    @GET("/registerCoachee")
    suspend fun register(@Query("email")email:String,@Query("password") password:String,@Query("username") username:String,@Query("coachCode")code:String):Response<Boolean>
    @GET("/refreshtoken")
